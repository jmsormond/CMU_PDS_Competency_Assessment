...
class IndicatorsControllerTest < ActionController::TestCase
  ...
  test "should create indicator" do
    assert_difference('Indicator.count') do
      post :create, indicator: { competency_id: @indicator.competency_id, description: @indicator.description, level: @indicator.level }
    end
  ...
  test "should update indicator" do
    patch :update, id: @indicator, indicator: { competency_id: @indicator.competency_id, description: @indicator.description, level: @indicator.level }
    assert_redirected_to indicator_path(assigns(:indicator))
  end
