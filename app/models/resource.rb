class Resource < ActiveRecord::Base
    ...
    scope :sort_by_competency, -> (query) {  joins(:indicators).joins("INNER JOIN competencies ON indicators.competency_id = competencies.id").where('competencies.name = ?', query).group("resources.name") }
